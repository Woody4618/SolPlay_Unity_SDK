...
public class TinyAdventureService : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        ServiceFactory.Resolve<TransactionService>().SendInstructionInNextBlock("Initializes",initializeInstruction, s =>
        {
            //GetGameData();
        });
    }
    ...
    public void MoveRight()
    {
        ...
        ServiceFactory.Resolve<TransactionService>().SendInstructionInNextBlock("Move Right", initializeInstruction, s =>
        {
            //GetGameData();
        });
    }
    ...
    public void MoveLeft()
    {
        ...
        ServiceFactory.Resolve<TransactionService>().SendInstructionInNextBlock("Move Left", initializeInstruction, s =>
        {
           // GetGameData();
        });
    }
