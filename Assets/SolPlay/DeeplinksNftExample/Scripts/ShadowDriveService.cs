...
{
    public class ShadowDriveService : MonoBehaviour
    {
        ...
        public async void UploadMetaData()
        {
            ...
            var initializeAccountInstruction = ShadowDriveUserStakingProgram.InitializeAccount2(accountsInstrucation, "MyShadow", 10000, programAddress);
